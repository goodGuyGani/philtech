...
import TransactionHistoryTable from "@/pages/tv-voucher/transaction-history/television-transaction-history-table"; // Update import path for TV vouchers
      ...
      <div className="flex flex-col w-full items-center">
        <div className="flex flex-col w-full max-w-9xl px-4 pt-6">
          ...
          <p className="text-muted-foreground mt-2">
            Here the transaction history of the TV Vouchers
          </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 mt-4 gap-4 w-full px-4">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Total TV Vouchers Used</CardTitle>
...
export default TelevisionTransactionHistory;
